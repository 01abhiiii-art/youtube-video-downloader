...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body>
    <header className="border-b border-ink/10 bg-cream/90 backdrop-blur sticky top-0 z-20"><div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
      <Link href="/" className="flex items-center gap-2 text-xl font-black tracking-tight" aria-label="ClipFetch home"><img src="/clipfetch-mark.svg" alt="" width="32" height="32" className="h-8 w-8" />clip<span className="text-emerald-600">fetch</span><span className="text-xs align-top text-emerald-600">.in</span></Link>
