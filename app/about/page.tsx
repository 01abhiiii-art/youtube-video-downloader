...
export const metadata: Metadata = { title: "About ClipFetch", description: "Learn about ClipFetch, a focused YouTube-only format analyzer and downloader.", alternates: { canonical: "https://clipfetch.in/about" } };
